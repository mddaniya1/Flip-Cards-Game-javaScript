...
const cardObjectDefinitions = [
    {id:1, imagePath:'/image/card-KingHearts.png'},
    {id:2, imagePath:'/image/card-JackClubs.png'},
    {id:3, imagePath:'/image/card-QueenDiamonds.png'},
    {id:4, imagePath:'/image/card-AceSpades.png'}
]
const aceId = 4

const cardBackImgPath = '/image/back.png'
